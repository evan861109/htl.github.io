...
Edit the homepage introduction under **Homepage content → Homepage About and biography text** using **Homepage About heading** and **Homepage About paragraphs**. These paragraphs are independent of **Full biography paragraphs**, which appear on the biography page. Edit each language separately. If the homepage paragraphs are left empty, the homepage uses the first two full biography paragraphs.
