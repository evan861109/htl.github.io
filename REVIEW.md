...
- Restored the original pre-review intro animation, including the staggered name/role reveal, curtain transition, homepage entrance timing, and replay on each visit. Reduced-motion preferences remain respected.
